...
// Regression suite for the PROXY-header parser size caps (#2187: the v1
// line cap propagates dnp3's #1348 fix to this mirror copy, and the v2
// address-block cap is new everywhere).
