      ...
      <SidebarMenuItem>
        ...
        {!user ? (
          ...
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton size="lg" tooltip="Account actions" aria-label="Account actions">
  ...
  return (
    <ShadcnSidebar collapsible="icon">
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild size="lg" tooltip="APIARY home">
              <Link to="/">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              type="button"
              tooltip="Search and investigate"
            ...
            >
              ...
              <span>Search and investigate</span>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarHeader>
      <SidebarContent><nav aria-label="Dashboard sections">
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                {recent.map((entry) => {
                  ...
                  return (
                    <SidebarMenuItem key={`${entry.kind}:${entry.value}`}>
                      <SidebarMenuButton asChild tooltip={label}>
                        <Link to={link.to} params={link.params} search={link.search} title={label}>
                          <span>{label}</span>
                        </Link>
                      </SidebarMenuButton>
                    </SidebarMenuItem>
