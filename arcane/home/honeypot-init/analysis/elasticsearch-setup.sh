  ...
  "processors": [
    {
      "script": {
        "lang": "painless",
        "ignore_failure": true,
        "params": {"home_net": __ES_HOME_NET_JSON__, "zeek_tcp_logs": ["ssl", "ssh", "http", "ftp", "rdp", "rfb", "ntlm", "ldap", "mysql", "smb_mapping", "smb_files", "smb_cmd", "ja4ssh", "smtp", "irc", "modbus", "modbus_detailed", "s7comm", "cotp"]},
