...
home (`honeypot-keycloak`, `arcane/home/honeypot-keycloak/compose.yml`). There is no
...
this up: deploy the Keycloak stack (`arcane/home/honeypot-keycloak/compose.yml`, Dockge-managed,
