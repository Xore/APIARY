...
| Rev·Deck (Ghidra AI chat) | `revdeck.<domain>` | `revdeck` :5000 (separate `analysis/ghidra/` stack, `revdeck` profile — see [analysis/ghidra/revdeck/README.md](../analysis/ghidra/revdeck/README.md)) |
