...
**FAILED to run — exit code -1073741515.** Not a "no tells found" result; this tool did not actually execute. Check the exit code against Windows NTSTATUS values (e.g. -1073741515 / 0xC0000135 = STATUS_DLL_NOT_FOUND) before trusting anything else in this report.
...
- System uptime: `39.8124346516667` minutes
