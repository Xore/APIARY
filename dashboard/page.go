...
var pageTemplate = pageStyle + settingsModal + pageOverview + pageEvents + pageIPs + pageSession + pageIntel + pagePayloads + pageSandbox + pageGhidra + pageOps + pageReports + pageSearch + pageMLAnomalies
