...
var pageTemplate = pageStyle + settingsModal + pageOverview + pageEvents + pageIPs + pageSession + pageIntel + pagePayloads + pageWorkbench + pageSandbox + pageGhidra + pageRevdeck + pageGitHubAnalysis + pageOps + pageReports + pageSearch + pageMLAnomalies
